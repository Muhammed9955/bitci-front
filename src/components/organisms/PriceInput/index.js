...
const PriceInput = ({
  ...
  return (
    <div className={priceInputClass} style={{ color: "black" }}>
      <Mobile className={$.left} component="div">
        <div
          className={cs($.aloneBtn, $.aloneDecreaseBtn)}
          onClick={() => onChange(decrease(price))}
        />
      </Mobile>
      ...
      <Mobile className={$.right} component="div">
        <div
          className={cs($.aloneBtn, $.aloneIncreaseBtn)}
          onClick={() => onChange(increase(price))}
        />
      </Mobile>
      <Desktop className={$.right} component="div">
        ...
        <div className={$.btns}>
          <div
            className={cs($.pairBtn, $.pairIncreaseBtn)}
            onClick={() => onChange(increase(price))}
          />
          <div
            className={cs($.pairBtn, $.pairDecreaseBtn)}
            onClick={() => onChange(decrease(price))}
          />
        </div>
      </Desktop>
