        ...
        <header>
          <ul className="box-list-items">
            <li className="multiple-links more-padding">
              <a className={marketBtn} onClick={() => this._setType(ORDER_TYPES.MARKET)} tabIndex="0">{l('market')}</a>
              <a className={limitBtn} onClick={() => this._setType(ORDER_TYPES.LIMIT)} tabIndex="0">{l('limit')}</a>
              <a className={stopBtn} onClick={() => this._setType(ORDER_TYPES.STOP)} tabIndex="0">{l('stop')}</a>
            </li>
          </ul>
        </header>
        <Inner type={type}/>
